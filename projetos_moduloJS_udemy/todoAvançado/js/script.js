...
const saveTodo = (text, done = 0, save = 1) => {
    // cria os elementos, adiciona suas classes e valores
    //adiciona a linha criada (todo) na tabela (todoList)
...
document.addEventListener("click", (e) => {
    ...
    const parentEl = targetEl.closest("div"); //o elemento div pai mais proximo
    let todoTitle;
    ...
    if (targetEl.classList.contains("finish-todo")) {
        parentEl.classList.toggle("done"); // toggle - ñ tem: adiciona, se tem: remove
